...
| mouse_mapped | 鼠标映射成功 |
| mouse_map_failed | 鼠标映射失败 |

**页面展示文案通过 event_type + device_type 组合生成：**

| event_type | device_type | 页面展示文案 |
|---|---|---|
| device_insert | storage | U盘插入 |
| device_insert | keyboard | 键盘插入 |
| device_insert | mouse | 鼠标插入 |
| device_insert | unknown / unsupported | 未知设备插入 |
| whitelist_denied | storage | 白名单拒绝 |
| whitelist_denied | unknown / unsupported | 未知设备禁止 |
